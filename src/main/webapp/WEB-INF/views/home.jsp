        ...
        <nav role="navigation" class="probootstrap-nav hidden-xs">
          <ul class="probootstrap-main-nav">
            ...
            <c:if test="${not empty memberId }">
            	<li><a href="/member/join">회원정보수정</a></li>
...
<html>
		...
		<div id="page-wrapper">
			...
			<!-- Banner -->
				<section id="banner">
					<div class="content">
						...
						<span class="image"><img src="/resources/img/pic01.jpg" alt="" /></span>
					</div>
			...
			<!-- One -->
				<section id="one" class="spotlight style1 bottom">
					<span class="image fit main"><img src="/resources/img/pic02.jpg" alt="" /></span>
					<div class="content">
						<div class="container">
							<div class="row">
			...
			<!-- Two -->
				<section id="two" class="spotlight style2 right">
					<span class="image fit main"><img src="/resources/img/pic03.jpg" alt="" /></span>
					<div class="content">
						<header>
			...
			<!-- Three -->
				<section id="three" class="spotlight style3 left">
					<span class="image fit main bottom"><img src="/resources/img/pic04.jpg" alt="" /></span>
					<div class="content">
						<header>
    ...
    <label for="toggleBtn" class="toggleBtn">DDDDDDDDDDDDDDDDDDDDDDDDD</label>
    <div class="box1"></div>
    <br>
		<!-- Scripts -->
